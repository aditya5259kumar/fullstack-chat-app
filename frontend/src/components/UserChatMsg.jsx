...
const UserChatMsg = () => {
  ...
  return (
    <div className="group flex items-center justify-between p-3 hover:bg-gray-100 cursor-pointer rounded-xl relative">
  ...
  <p className="text-gray-500 text-sm truncate">
    This is a very long message that should never break your UI no matter what happens
  </p>
</div>
      </div>
      ...
      <div className="flex items-center gap-3 ml-2 shrink-0">
        <div className="flex flex-col gap-1 items-end">
          <p className="text-sm text-gray-400 whitespace-nowrap">09:55 PM</p>

          <div className="flex items-center gap-2">
            <BsFillPinAngleFill className="text-gray-500 text-base" />
            <span className="text-white text-xs px-2 py-0.5 bg-red-500 rounded-full">
              12
            </span>
          </div>
        </div>
