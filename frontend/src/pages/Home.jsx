...
import { FAKE_CHATS } from "./AllChats";
...
const Home = () => {
  ...
  const activeChat = chatId
    ? FAKE_CHATS.find((c) => c.id === parseInt(chatId))
    : null;
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 min-w-0">
      ...
      <div className={`${isMobileChatOpen ? "hidden md:flex" : "flex flex-1"} flex-col min-w-0 ring-5 ring-gray-50 border border-gray-50`}>
        <AllChats
